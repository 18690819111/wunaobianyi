...
uci set network.lan.dns='61.128.114.134 61.128.114.167'           # DNS(多个DNS要用空格分开)
...
uci set system.@system[0].hostname='OpenWrt-zheng'              # 修改主机名称为OpenWrt-123
...
sed -i "s/OpenWrt /亓申言舌 compiled in $(TZ=UTC-8 date "+%Y.%m.%d") @ OpenWrt /g" $ZZZ_PATH
